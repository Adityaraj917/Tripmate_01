...
import { Mail, Lock, Compass, Eye, EyeOff, Plane, MapPin, Globe } from 'lucide-react'
    ...
    <div className="auth-split">
      ...
      <div className="auth-visual hidden">
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-12 z-10">
          ...
          <div className="absolute top-[15%] left-[10%] text-5xl animate-float-slow opacity-30">✈️</div>
          <div className="absolute top-[25%] right-[15%] text-4xl animate-float-reverse opacity-25">🎈</div>
          <div className="absolute bottom-[30%] left-[15%] text-4xl animate-float opacity-25">🧭</div>
          <div className="absolute bottom-[15%] right-[10%] text-5xl animate-float-slow opacity-30">🌍</div>
          <div className="absolute top-[50%] left-[5%] text-3xl animate-float-reverse opacity-20">⛰️</div>
          <div className="absolute top-[60%] right-[5%] text-3xl animate-float opacity-20">🏝️</div>
          ...
          <div className="animate-bounce-in">
            ...
            <p className="text-white/70 text-base font-inter max-w-sm">
              Plan trips, track expenses, explore destinations, and travel with friends — all in one place.
            </p>
      ...
      <div className="auth-form min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-1/2 gradient-header-tall opacity-20 blur-3xl desktop:opacity-10" />
        ...
        <div className="desktop:hidden absolute top-[10%] right-[8%] text-2xl animate-float-slow opacity-15">✈️</div>
        <div className="desktop:hidden absolute bottom-[20%] left-[8%] text-2xl animate-float-reverse opacity-15">🌍</div>

        <div className="w-full max-w-sm relative z-10 animate-fade-in">
          {/* Logo */}
          <div className="text-center mb-10 animate-bounce-in">
            <div className="w-16 h-16 mx-auto mb-4 gradient-header rounded-2xl flex items-center justify-center shadow-lg shadow-primary/30 animate-float">
          ...
          {/* Divider */}
          <div className="flex items-center gap-4 my-6 animate-fade-in stagger-4">
            <div className="flex-1 h-px bg-white/10" />
            <span className="text-muted-text text-xs">or</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          {/* Sign Up Link */}
          <p className="text-center text-muted-text text-sm mt-8 animate-fade-in stagger-6">
